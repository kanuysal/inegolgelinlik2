...
with open('app/sell/submit/page.tsx', 'w', encoding='utf-8') as f:
    f.write(jsx_content)

print("Seller wizard page successfully reconstructed based on Stitch mockups.")
